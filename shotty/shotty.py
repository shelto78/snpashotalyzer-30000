...
@click.option('--all', 'list_all', default=False, is_flag=True,
    help="List all snapshots for each volume, not just the recent snapshots")
@click.pass_context

def list_snapshots(self, project, list_all):
    "List EC2 Snapshots"
...
def stop_instances(self, project):
    "Stop EC2 Instances"
...
def start_instances(self, project):
    "Start EC2 Instances"
